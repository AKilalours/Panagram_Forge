...
| 1 | FORGE-HUMAN v0.1 | 400k train + 50k eval + 5M reserve in Parquet, MANIFEST.json written, zero group leakage across splits |
| 2 | FORGE-MIRROR v0.1 | 400k mirrors, mirror validation rejection rate reported, length/topic match distributions plotted |
